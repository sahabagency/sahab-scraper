...
export async function inferBusinessIntelligence({html='',url='',lead={},assumptions={}}={}){
  ...
  const serviceCommerce=Boolean(servicePurchaseDetected || (home.service && (home.booking || home.paymentMethods)));
  const siteMode=directCommerce&&serviceCommerce?'service_commerce':directCommerce?'ecommerce_store':(bookingDetected||quoteRequestDetected||home.contact)?'lead_generation_service':'informational_website';
